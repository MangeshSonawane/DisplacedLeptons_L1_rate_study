...
#    h_pt_res	= R.TH2F('h_pt_res', 'Muon PT resolution, Gen Dxy = 40 cm, m_{LLP} = 25 GeV; Gen Muon PT [GeV]; Muon (PT-Gen Pt)/Gen Pt', 40, 0, 20, 30, -1, 2)
    ...
    PT_res_slices = [0, 4, 6, 8, 10, 20]

    h_upt_res_EMTF= R.TH2F('h_upt_res_EMTF', 'L1 IP >= 1, m_{LLP} = '+ LLP_mass+', EMTF; L1 UPT [GeV]; Muon (UPT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)
    h_pt_res_EMTF= R.TH2F('h_pt_res_EMTF', 'L1 IP >= 1, m_{LLP} = '+ LLP_mass+', EMTF; L1 PT [GeV]; Muon (PT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)

    h_upt_res_KBMTF= R.TH2F('h_upt_res_KBMTF', 'L1 IP >= 1, m_{LLP} = '+ LLP_mass+', KBMTF; L1 UPT [GeV]; Muon (UPT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)
    h_pt_res_KBMTF= R.TH2F('h_pt_res_KBMTF', 'L1 IP >= 1, m_{LLP} = '+ LLP_mass+', KBMTF; L1 PT [GeV]; Muon (PT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)

    h_gen_upt_res_EMTF= R.TH2F('h_gen_upt_res_EMTF', 'Gen Dxy >= 25 cm, m_{LLP} = '+ LLP_mass+', EMTF; Gen UPT [GeV]; Muon (UPT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)
    h_gen_pt_res_EMTF= R.TH2F('h_gen_pt_res_EMTF', 'Gen Dxy >= 25 cm, m_{LLP} = '+ LLP_mass+', EMTF; Gen PT [GeV]; Muon (PT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)

    h_gen_upt_res_KBMTF= R.TH2F('h_gen_upt_res_KBMTF', 'Gen Dxy >= 30 cm, m_{LLP} = '+ LLP_mass+', KBMTF; Gen UPT [GeV]; Muon (UPT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)
    h_gen_pt_res_KBMTF= R.TH2F('h_gen_pt_res_KBMTF', 'Gen Dxy >= 30 cm, m_{LLP} = '+ LLP_mass+', KBMTF; Gen PT [GeV]; Muon (PT-Gen Pt)/Gen Pt', \
				5, array('d', PT_res_slices), 60, -1, 5)
...
###############################	
			...
			if L1_DoubleMu_15_7_flag or (L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4_flag or L1_DoubleMu4p5_SQ_OS_dR_Max1p2_flag) : 
			...
			if L1_DoubleMu_15_7_flag or (L1_DoubleMu_6_4_UPT_DXY1_flag) : Baseline_Run_2_UPT_dxy1_num += 1.
			if L1_DoubleMu_15_7_flag or L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4_flag or L1_DoubleMu4p5_SQ_OS_dR_Max1p2_flag or L1_DoubleMu_6_4_UPT_DXY1_flag :
